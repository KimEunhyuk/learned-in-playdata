...
-- playdata 라는 새로운 database 생성
CREATE DATABASE playdata;

show databases;

-- playdata 라는 database 활용
USE playdata;
...
-- oracle db에선 number 타입 -> mysql db에선 int
CREATE TABLE dept (
    deptno               int  NOT NULL ,
    dname                varchar(20),
    loc                  varchar(20),
...
-- oracle sequence -> mysql 에선 AUTO_INCREMENT
-- oracle의 실수 -> mysql에선 numeric(7,2)
CREATE TABLE emp (
